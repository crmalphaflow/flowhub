...
function initVoiceAgentWidget() {
  ...
  function startFallbackDemo(error) {
    ...
    setWidgetState('error', 'Live-Verbindung nicht erreichbar');
    addTranscript('Die Live-Verbindung ist momentan nicht erreichbar. Bitte versuchen Sie es gleich erneut.', 'system');
